...
import { postUserValidator, updateUserValidator } from '../validators/user.validator';
...
export const postUser = async (req: express.Request<{},{},UserInterface> , res: express.Response) => {
  try {
    // postUserValidator.validate(req.body, {abortEarly: false});
...
export const updateUser = async (req: express.Request, res: express.Response) => {
  try {
    // updateUserValidator.validate(req.body, {abortEarly: false});
    const { id } = req.params;
